"""Sample submission for PyCon LT 2023 Beautiful is Better Than Ugly Exhibition

Taken from https://github.com/sobolevn/python-code-disasters/blob/master/python/generate_pid.py
Not intended to win :)
"""
